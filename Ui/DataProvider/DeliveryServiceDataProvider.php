...
namespace ArtemiiKarkusha\AdobeCommercePreparingToCertification\Ui\DataProvider;

use ArtemiiKarkusha\AdobeCommercePreparingToCertification\Api\Data\DeliveryServiceInterface;
use ArtemiiKarkusha\AdobeCommercePreparingToCertification\Query\DeliveryService\GetListQuery;
...
class DeliveryServiceDataProvider extends DataProvider
{
    ...
    public function getData(): array
    {
        ...
        foreach ($this->loadedData['items'] as $item) {
            $itemsById[(int)$item[DeliveryServiceInterface::ENTITY_ID]] = $item;
        }

        if ($id = $this->request->getParam(DeliveryServiceInterface::ENTITY_ID)) {
